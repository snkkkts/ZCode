...
const enUS: Record<string, string> = {
  ...
  "settings.appearanceThemes.title": "Themes",
  "settings.appearanceThemes.description":
    "Apply a built-in palette, or save the current appearance as your own theme and switch at any time.",
  "settings.appearanceThemes.builtin": "Built-in palettes",
  "settings.appearanceThemes.builtinHelp":
    "Replaces light and dark colors only; fonts, opacity, math, chat text and the background image stay unchanged.",
  "settings.appearanceThemes.applyPalette": "Apply built-in palette {name}",
  "settings.appearanceThemes.mine": "My themes",
  "settings.appearanceThemes.mineHelp":
    "Saves every custom appearance setting except the background image; applying keeps the current background. Up to {max} themes.",
  "settings.appearanceThemes.newName": "New theme name",
  "settings.appearanceThemes.namePlaceholder": "Theme name",
  "settings.appearanceThemes.saveNew": "Save current as new theme",
  "settings.appearanceThemes.empty": "No saved themes yet.",
  "settings.appearanceThemes.rename": "Rename theme {name}",
  "settings.appearanceThemes.apply": "Apply",
  "settings.appearanceThemes.applyTheme": "Apply theme {name}",
  "settings.appearanceThemes.overwrite": "Overwrite with current",
  "settings.appearanceThemes.overwriteTheme": "Overwrite theme {name} with the current appearance",
  "settings.appearanceThemes.duplicate": "Duplicate",
  "settings.appearanceThemes.duplicateTheme": "Duplicate theme {name}",
  "settings.appearanceThemes.copySuffix": "copy",
  "settings.appearanceThemes.delete": "Delete",
  "settings.appearanceThemes.deleteTheme": "Delete theme {name}",
  "settings.appearanceThemes.confirmDelete": "Confirm delete",
  "settings.appearanceThemes.confirmDeleteTheme": "Confirm deleting theme {name}",
  "settings.appearanceThemes.applied": "Applied “{name}”.",
  "settings.appearanceThemes.saved": "Saved theme “{name}”.",
  "settings.appearanceThemes.renamed": "Renamed to “{name}”.",
  "settings.appearanceThemes.overwritten": "Overwrote “{name}” with the current appearance.",
  "settings.appearanceThemes.duplicated": "Duplicated as “{name}”.",
  "settings.appearanceThemes.deleted": "Deleted “{name}”.",
  "settings.appearanceThemes.saveFailed":
    "Could not save themes; the list was not changed. Check local storage space.",
  "settings.appearanceThemes.applyFailed":
    "Could not apply; the current appearance was not changed. Check local storage space.",
  ...
  "settings.customAppearance.color.quoteText": "Quote text",
  "settings.customAppearance.color.quoteBorder": "Quote bar",
  "settings.customAppearance.color.quoteBackground": "Quote background",
  "settings.customAppearance.color.heading": "Headings",
  "settings.customAppearance.color.strong": "Bold text",
  "settings.customAppearance.color.listMarker": "List markers",
  "settings.customAppearance.color.tableHeader": "Table headers",
  "settings.customAppearance.chatTypography": "Chat text",
  "settings.customAppearance.chatFont": "Chat font",
  "settings.customAppearance.chatFontSize": "Chat font size ({min}–{max} px)",
  "settings.customAppearance.chatLineHeight": "Chat line height ({min}–{max}%)",
  "settings.customAppearance.chatInherit": "Blank to inherit",
  "settings.customAppearance.chatTypographyHelp":
    "Applies only to user messages and assistant replies in conversations. Headings keep their hierarchy; code blocks, buttons, inputs and the terminal are unaffected. Leave blank to inherit.",
