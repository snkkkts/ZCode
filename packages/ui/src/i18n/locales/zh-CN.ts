...
const zhCN: Record<string, string> = {
  "settings.appearanceCode.title": "外观配置代码（JSON）",
  "settings.appearanceCode.help":
    '这里显示当前配置（不含背景图片），直接修改会在停止输入后自动应用；也可只粘贴部分字段。未写出的字段和背景图片保持不变，颜色写 "" 可恢复继承主题。导出会复制包含背景图片的完整配置。最大 3 MiB。',
  "settings.appearanceCode.export": "导出并复制",
  "settings.appearanceCode.import": "立即应用",
  "settings.appearanceCode.importing": "正在检查…",
  "settings.appearanceCode.copied": "已复制完整配置（含背景图片）到剪贴板。",
  "settings.appearanceCode.manualCopy": "无法访问剪贴板，完整配置已放入代码框，请手动复制。",
  "settings.appearanceCode.imported": "已应用并保存。",
  "settings.appearanceCode.invalid": "配置无效（{field}），当前外观未更改。",
  "settings.appearanceCode.saveFailed":
    "保存失败，当前外观未更改。请检查存储空间或使用较小的背景图片。",
  "settings.appearanceThemes.title": "主题方案",
  "settings.appearanceThemes.description":
    "一键套用内置配色，或把当前外观保存为自己的方案，随时切换。",
  "settings.appearanceThemes.builtin": "内置配色",
  "settings.appearanceThemes.builtinHelp":
    "只替换浅深色配色；字体、透明度、公式、聊天排版和背景图片保持不变。",
  "settings.appearanceThemes.applyPalette": "套用内置配色 {name}",
  "settings.appearanceThemes.mine": "我的方案",
  "settings.appearanceThemes.mineHelp":
    "保存当前自定义外观的全部设置（不含背景图片），应用时保留当前背景。最多 {max} 个。",
  "settings.appearanceThemes.newName": "新方案名称",
  "settings.appearanceThemes.namePlaceholder": "方案名称",
  "settings.appearanceThemes.saveNew": "保存当前为新方案",
  "settings.appearanceThemes.empty": "还没有保存的方案。",
  "settings.appearanceThemes.rename": "重命名方案 {name}",
  "settings.appearanceThemes.apply": "应用",
  "settings.appearanceThemes.applyTheme": "应用方案 {name}",
  "settings.appearanceThemes.overwrite": "用当前覆盖",
  "settings.appearanceThemes.overwriteTheme": "用当前外观覆盖方案 {name}",
  "settings.appearanceThemes.duplicate": "复制",
  "settings.appearanceThemes.duplicateTheme": "复制方案 {name}",
  "settings.appearanceThemes.copySuffix": "副本",
  "settings.appearanceThemes.delete": "删除",
  "settings.appearanceThemes.deleteTheme": "删除方案 {name}",
  "settings.appearanceThemes.confirmDelete": "确认删除",
  "settings.appearanceThemes.confirmDeleteTheme": "确认删除方案 {name}",
  "settings.appearanceThemes.applied": "已应用“{name}”。",
  "settings.appearanceThemes.saved": "已保存方案“{name}”。",
  "settings.appearanceThemes.renamed": "已重命名为“{name}”。",
  "settings.appearanceThemes.overwritten": "已用当前外观覆盖“{name}”。",
  "settings.appearanceThemes.duplicated": "已复制为“{name}”。",
  "settings.appearanceThemes.deleted": "已删除“{name}”。",
  "settings.appearanceThemes.saveFailed": "方案保存失败，列表未更改。请检查本地存储空间。",
  "settings.appearanceThemes.applyFailed": "应用失败，当前外观未更改。请检查本地存储空间。",
  "settings.customAppearance.title": "自定义外观",
  "settings.customAppearance.description":
    "即时预览并保存到本机。背景与文字分层控制，可随时恢复默认。",
  "settings.customAppearance.reset": "恢复自定义外观默认值",
  "settings.customAppearance.background": "背景图片",
  "settings.customAppearance.backgroundHelp":
    "支持 PNG、JPEG、WebP，最大 2 MiB。降低面板不透明度可露出背景。",
  "settings.customAppearance.chooseImage": "选择图片",
  "settings.customAppearance.clearImage": "清除图片",
  "settings.customAppearance.loading": "正在读取图片…",
  "settings.customAppearance.fit": "图片填充方式",
  "settings.customAppearance.cover": "铺满并裁剪",
  "settings.customAppearance.contain": "完整显示",
  "settings.customAppearance.overlay": "背景遮罩",
  "settings.customAppearance.blur": "背景模糊",
  "settings.customAppearance.panelOpacity": "主面板不透明度",
  "settings.customAppearance.sidebarOpacity": "侧栏不透明度",
  "settings.customAppearance.font": "界面字体",
  "settings.customAppearance.fontHelp":
    "填写已安装的字体名称，可用逗号分隔；留空继承默认。代码字体见下方，终端字体保持独立。",
  "settings.customAppearance.colors": "编辑配色",
  "settings.customAppearance.light": "浅色主题配色",
  "settings.customAppearance.dark": "深色主题配色",
  "settings.customAppearance.colorsHelp":
    "浅深色分别保存；切换应用主题可预览对应配色。“继承主题”表示未覆盖。",
  "settings.customAppearance.inherit": "继承主题",
  "settings.customAppearance.resetColor": "重置",
  "settings.customAppearance.saveFailed":
    "保存失败，原配置已保留。请尝试较小的图片或检查本地存储权限。",
  "settings.customAppearance.type": "请选择 PNG、JPEG 或 WebP 图片。",
  "settings.customAppearance.size": "图片超过 2 MiB，请先压缩或选择较小的图片。",
  "settings.customAppearance.decode": "无法读取图片，请选择有效的图片文件。",
  "settings.customAppearance.color.background": "应用背景",
  "settings.customAppearance.color.sidebar": "侧栏背景",
  "settings.customAppearance.color.panel": "面板背景",
  "settings.customAppearance.color.card": "卡片背景",
  "settings.customAppearance.color.input": "输入框背景",
  "settings.customAppearance.color.brand": "强调色",
  "settings.customAppearance.color.foreground": "正文颜色",
  "settings.customAppearance.color.secondaryText": "辅助文字",
  "settings.customAppearance.color.border": "边框颜色",
  "settings.customAppearance.color.quoteText": "引用文字",
  "settings.customAppearance.color.quoteBorder": "引用竖线",
  "settings.customAppearance.color.quoteBackground": "引用底色",
  "settings.customAppearance.color.heading": "标题颜色",
  "settings.customAppearance.color.strong": "加粗文字",
  "settings.customAppearance.color.listMarker": "列表符号",
  "settings.customAppearance.color.tableHeader": "表头文字",
  "settings.customAppearance.chatTypography": "聊天正文排版",
  "settings.customAppearance.chatFont": "正文字体",
  "settings.customAppearance.chatFontSize": "正文字号（{min}–{max} px）",
  "settings.customAppearance.chatLineHeight": "正文行距（{min}–{max}%）",
  "settings.customAppearance.chatInherit": "留空继承",
  "settings.customAppearance.chatTypographyHelp":
    "只作用于对话中的用户消息和助手回复；标题保持原有层级，代码块、按钮、输入框和终端不受影响。留空恢复继承。",
  "settings.customAppearance.color.math": "公式颜色",
  "settings.customAppearance.mathBold": "公式加粗",
  "settings.customAppearance.mathScale": "公式字号",
  "settings.customAppearance.mathHelp":
    "作用于对话中的 LaTeX 公式。字号相对正文，默认 121%；公式内 \\color、\\mathbf 等写法仍优先生效。",
  "settings.customAppearance.color.link": "链接颜色",
  "settings.customAppearance.color.inlineCode": "行内代码底色",
  "settings.customAppearance.color.primary": "主按钮颜色",
  "settings.customAppearance.color.primaryText": "主按钮文字",
  "settings.customAppearance.codeFont": "代码字体",
  "settings.customAppearance.codeFontHelp":
    "用于代码块、行内代码、代码预览与 Diff；留空继承默认。终端字体在终端设置中单独配置。",
